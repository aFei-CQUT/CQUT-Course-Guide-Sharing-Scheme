...
IGNORE_EXTENSIONS = [
    '.pyc', '.md', '.png', '.idx', '.pack', '.rev', '.sample', 'jpg', '.xmind', '.pdf', '.docx', '.gif', '.cls', '.dtx', '.ins', '.doc', '.pptx', '.py', '.gz', '.sty', '.lodf', '.cls', '.cpp'
]

IGNORE_FILES = [
    '.gitattributes', '.ignore', 'LICENSE', 'psheader.txt', 'thesisbib.bib'
]
